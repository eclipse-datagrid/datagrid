...
public class MicronautClusterController
{
	...
	@Post(value = PostBackup.PATH, consumes = PostBackup.CONSUMES, produces = PostBackup.PRODUCES)
	...
	@Post(value = PostUpdates.PATH, consumes = PostUpdates.CONSUMES, produces = PostUpdates.PRODUCES)
	...
	@Post(value = PostResumeUpdates.PATH, consumes = PostResumeUpdates.CONSUMES, produces = PostResumeUpdates.PRODUCES)
