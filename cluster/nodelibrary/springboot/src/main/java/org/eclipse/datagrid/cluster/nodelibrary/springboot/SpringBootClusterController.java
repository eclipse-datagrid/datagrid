...
public class SpringBootClusterController
{
	...
	@PostMapping(value = PostBackup.PATH, consumes = PostBackup.CONSUMES, produces = PostBackup.PRODUCES)
	...
	@PostMapping(value = PostUpdates.PATH, consumes = PostUpdates.CONSUMES, produces = PostUpdates.PRODUCES)
	...
	@PostMapping(value = PostGc.PATH, consumes = PostGc.CONSUMES, produces = PostGc.PRODUCES)
