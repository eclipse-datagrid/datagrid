...
/**
 * A {@link StorageBinaryDataPacketAcceptor} that will not dispose the {@link StorageBinaryDataMessage}s so they can be
 * cached and disposed by the {@link ClusterStorageBinaryDataMerger}. This class will also call {@link #dispose()} on
 * the {@link ClusterStorageBinaryDataMerger}
 */
