...
public interface StorageLimitCheckerQuartzCronJobManager extends QuartzCronJobManager
{
    ...
    static StorageLimitCheckerQuartzCronJobManager New(final int storageSizeLimitGb, final StorageDiskSpaceReader diskSpaceReader)
    {
    ...
    final class Default implements StorageLimitCheckerQuartzCronJobManager
    {
        ...
        public Job create()
        {
            return new StorageLimitCheckerQuartzCronJob(this.limitReached::set, this.storageSizeLimitGb, this.diskSpaceReader);
        }
    ...
    final class StorageLimitCheckerQuartzCronJob implements Job
    {
        ...
        private StorageLimitCheckerQuartzCronJob(final Consumer<Boolean> limitReachedCallback, final int storageSizeLimitGb, final StorageDiskSpaceReader diskSpaceReader)
        {
