...
public class ClusteredCacheMessageReceiver implements Disposable
{
    private static final Logger logger = LoggerFactory.getLogger(ClusteredCacheMessageReceiver.class);
    ...
    public ClusteredCacheMessageReceiver(
