...
{
	public static StorageBinaryDataDistributorKafka Sync(final Properties kafkaProperties, final String topicName)
	{
		return new StorageBinaryDataDistributorKafka.Sync(notNull(kafkaProperties), notEmpty(topicName));
	}

	public static StorageBinaryDataDistributorKafka Async(final Properties kafkaProperties, final String topicName)
	{
		return new StorageBinaryDataDistributorKafka.Async(notNull(kafkaProperties), notEmpty(topicName));
	}
	...
	static abstract class Abstract implements StorageBinaryDataDistributorKafka
	{
		...
		{
			return this.kafkaProducer != null ? this.kafkaProducer : (this.kafkaProducer = this.createProducer());
		}
	...
	{
		Sync(final Properties kafkaProperties, final String topicName)
		{
	...
	public static class Async extends Abstract
	{
		...
		Async(final Properties kafkaProperties, final String topicName)
		{
			super(kafkaProperties, topicName);
